...
const Application = () => {
  ...
  const handleFileChange = (event) => {
    ...
    // Check file type - Allow images, PDF, and Word documents
    const allowedTypes = [
      "image/png",
      "image/jpeg",
      "image/webp",
    ...
    if (!allowedTypes.includes(file.type)) {
      setFileError("Please select a valid file (PNG, JPEG, WEBP, PDF, or Word document)");
      setResume(null);
      return;
    }
          ...
          <div>
            ...
            >
              ...
              <p style={{ color: "red", fontSize: "12px", margin: "5px 0 0 0" }}>
                (Supported formats: PNG, JPEG, WEBP, PDF, Word. Max size: 3MB)
              </p>
            </label>
            <input
              type="file"
